...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TP1_SwiftUI_three_screens",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC25TP1_SwiftUI_three_screens11AppDelegate")
...
SWIFT_CLASS("_TtC25TP1_SwiftUI_three_screens13SceneDelegate")
